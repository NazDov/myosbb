...
import ua.ssmt.softserveinc.com.lvklegals.webservice.applogic.datalayer.queries.delete.DeleteTariffQuery;
 ...
 */
public class DeleteTariffOperation extends AbstractModifyOperation<Tariff> {

    public DeleteTariffOperation() {
        super(new TariffValidator());
    }

    @Override
    protected long _doOperation(Connection connection, Tariff value)   {
        return new DeleteTariffQuery().execute(connection,value);
    }
