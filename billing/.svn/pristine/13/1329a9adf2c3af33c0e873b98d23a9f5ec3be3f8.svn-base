 ...
 */
public class HotWatterSupplierQuery extends AbstractSelectQuery<HotWaterSupplier,Void> {
    public HotWatterSupplierQuery(Void condition) {
        super(condition);
    }
    @Override
    protected HotWaterSupplier parseResultSet(ResultSet rs) throws SQLException {
        HotWaterSupplier res = new HotWaterSupplier(rs.getLong("id"));
    ...
    protected String getSQLQuery() {
        ...
        sb.append(" where 1=1  ");*/
        sb.append(" select * from RefContragents   ");
        sb.append("         where   HotWatterSupplier = 1  ");
