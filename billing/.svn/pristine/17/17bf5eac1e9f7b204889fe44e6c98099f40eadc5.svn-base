 ...
 */
public class GetUnregisterOfCounterDocumentByDepartmentInputInPeriod extends AbstractSelectPreCompileQuery<UnregisterOfCounter,UnregisterOfCounterCondition> {
    public GetUnregisterOfCounterDocumentByDepartmentInputInPeriod(Connection connection) {
    ...
    protected void fillStatement(PreparedStatement st) throws SQLException {
        ...
        st.setDate(3, new Date(condition.getPeriod().getTime()));
    }
    ...
    protected String getSQLQuery() {
        ...
        sb.append(        " where 1=1 ");
        sb.append(        " and  DepartmentID = ? and InputID = ? and Period = ?  ");
