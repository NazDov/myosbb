 ...
 */
public class GetAllUnregisterOfCounterQuery extends AbstractSelectQuery<UnregisterOfCounter,Void> {
    public GetAllUnregisterOfCounterQuery(Void condition) {
        super(condition);
    }
    ...
    protected String getSQLQuery() {
        ...
        sb.append(" where departmentInputID in (select departmentInputID from dbo.getDepartmentInputByID()) ");
