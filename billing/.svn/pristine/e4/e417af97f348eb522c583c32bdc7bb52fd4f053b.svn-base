...
import ua.ssmt.softserveinc.com.lvklegals.webservice.applogic.datalayer.queries.create.CreateDiscountRateQuery;
 ...
 */
public class CreateDiscountRateOperation extends AbstractModifyOperation<DiscountRateNBU> {
    public CreateDiscountRateOperation() {
        super(new DiscountNBUValidator());
    }

    @Override
    protected long _doOperation(Connection connection, DiscountRateNBU value)   {
        return new CreateDiscountRateQuery().execute(connection,value);
    }
