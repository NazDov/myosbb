 ...
 */
public class SearchInvoiceForHotWatterSupplierQuery extends AbstractSelectQuery<CalcInvoice,CalcInvoiceCondition> {
    public SearchInvoiceForHotWatterSupplierQuery(CalcInvoiceCondition condition) {
        super(condition);
    }
