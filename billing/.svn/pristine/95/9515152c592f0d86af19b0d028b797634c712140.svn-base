...
import ua.ssmt.softserveinc.com.lvklegals.webservice.applogic.datalayer.queries.delete.DeletePaymentTypeQuery;
 ...
 */
public class DeletePaymentTypeOperation extends AbstractModifyOperation<PaymentType> {
    public DeletePaymentTypeOperation() {
        super(new PaymentTypeValidator());
    }

    @Override
    protected long _doOperation(Connection connection, PaymentType value)   {
        return new DeletePaymentTypeQuery().execute(connection,value);
    }
