...
/**
 * Created by vostap on 01.04.2015.
 */
public class SelectDepartmentInput extends AbstractSelectQuery<DepartmentInput,DepartmentInputCondition> {
    public SelectDepartmentInput(DepartmentInputCondition condition) {
        super(condition);
    }
