 ...
 */
public class SearchAgreementContrAgentQuery extends AbstractSelectQuery<Agreement,AgreementCondition> {
    public SearchAgreementContrAgentQuery(AgreementCondition condition) {
        super(condition);
    }
    ...
    protected String getSQLQuery() {
        ...
        sb.append(" ,[IsActive]   ");
        sb.append(" FROM [dbo].[DocAgreement] where 1=1 ");
