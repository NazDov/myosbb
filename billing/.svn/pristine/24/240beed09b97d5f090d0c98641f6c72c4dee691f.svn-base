...
/**
 * Created by vostap on 8/20/2015.
 */
public class SearchContraAgentForBankQuery extends AbstractSelectQuery<ContraAgent,ContraAgentCondition> {

    public SearchContraAgentForBankQuery(ContraAgentCondition condition) {
        super(condition);
    }
    ...
    protected String getSQLQuery() {
        ...
        sb.append(" select top "+ Options.getMaxCountToSelectRow()+" ca.[id]  as contraAgentID                        ");
        sb.append(" ,ca.[EDRPO]                                             ");
        sb.append(" ,ca.[IPN]                                               ");
        sb.append(" ,ca.[VATNum]                                            ");
        ...
        if (condition.getMfo() != null){
            sb.append(" and b.MFO = '"+condition.getMfo()+"'");
        }
        //(sb.toString());
        return sb.toString();
    }
