 ...
 */
public class SearchContraAgentQuery extends AbstractSelectQuery<ContraAgent,ContraAgentCondition> {

    public SearchContraAgentQuery(ContraAgentCondition condition) {
        super(condition);
    }
    ...
    protected ContraAgent parseResultSet(ResultSet rs) throws SQLException {
        ...
        res.setHotWatterSupplier(rs.getBoolean("HotWatterSupplier"));
        ...
        res.setFilija(rs.getString("filija"));
    ...
    private ContraAgentProperty fillProperties(ResultSet rs) throws SQLException {
        ...
        res.setLimitVK(rs.getFloat("Limit_VK"));
    ...
    private Algorithm fillAlgorithm(ResultSet rs) throws SQLException {
        Algorithm ca = new Algorithm();
        ca.setId(rs.getLong("Algorithm"));
        return ca;
    }
    @Override
    protected String getSQLQuery() {
        StringBuilder sb = new StringBuilder();
        sb.append(" select top 100 ca.[id]  as contraAgentID                ");
        sb.append(" ,ca.[EDRPO]                                             ");
        sb.append(" ,ca.[IPN]                                               ");
        sb.append(" ,ca.[VATNum]                                            ");
        ...
        sb.append(" ,ca.[HotWatterSupplier]                                 ");
        sb.append(" ,ca.[filija]                                             ");
