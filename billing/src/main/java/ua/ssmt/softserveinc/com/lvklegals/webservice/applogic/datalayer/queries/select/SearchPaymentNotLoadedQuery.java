 ...
 */
public class SearchPaymentNotLoadedQuery extends AbstractSelectQuery<PaymentToDelete, PaymentCondition> {
    public SearchPaymentNotLoadedQuery(PaymentCondition condition) {
        super(condition);
    }

    @Override
    protected PaymentToDelete parseResultSet(ResultSet rs) throws SQLException {
        PaymentToDelete res = new PaymentToDelete();
    ...
    private Correction fillCorrection(ResultSet rs) throws SQLException {
        ...
        res.setId(rs.getLong("CorrectionID"));
        return res;
    }
    ...
    protected String getSQLQuery() {
        ...
        sb.append("         ,'' as ShortName            ");
        sb.append(" ,p.DocAgreementID                   ");
        sb.append("         ,'' as AgreementNumber      ");
        ...
        sb.append(" FROM DocPaymentNotLoaded as p       ");
        sb.append(" left join RefBanks as b on  p.BankID = b.id  ");
        sb.append(" left join refOwnerBankAccount as ba on  p.OwnerBankAccountID = ba.id where 1=1 and p.ContraAgentID is null  ");
