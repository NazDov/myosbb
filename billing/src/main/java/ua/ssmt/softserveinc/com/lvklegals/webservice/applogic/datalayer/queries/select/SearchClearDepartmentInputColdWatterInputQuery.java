 ...
 */
public class SearchClearDepartmentInputColdWatterInputQuery extends AbstractSelectQuery<DepartmentInput,DepartmentInputCondition> {

    public SearchClearDepartmentInputColdWatterInputQuery(DepartmentInputCondition condition) {
        super(condition);
    }
    ...
    protected String getSQLQuery() {
        ...
        sb.append(        "   where di.Period <= dbo.getCurrentPeriod()and input.ServiceID = 1 \n ");
