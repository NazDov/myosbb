...
import ua.ssmt.softserveinc.com.lvklegals.webservice.applogic.datalayer.queries.delete.DeleteUploadedCommisionQuery;
 ...
 */
public class DeleteCommisionLoaded extends AbstractModifyOperation<Void> {
    private List<Commission> condionToDelete;


    public DeleteCommisionLoaded(List<Commission> condionToDelete) {
    ...
    protected long _doOperation(Connection connection, Void value) {
        ...
        /*    AlgoritmCondition algoritmCondition = new AlgoritmCondition();
            ...
            new DeleteUploadedCommisionQuery().execute(connection,p);
        }
        return 0;
