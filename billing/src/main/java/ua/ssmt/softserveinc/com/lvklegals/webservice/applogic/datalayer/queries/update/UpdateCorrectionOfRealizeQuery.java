 ...
 */
public class UpdateCorrectionOfRealizeQuery extends AbstractModifyQuery<CorrectionOfRealize> {
    @Override
    protected String getSQLQuery() {
        StringBuilder sb = new StringBuilder();
        sb.append(" UPDATE [dbo].[DocCorrectionOfRealize]   ");
        sb.append(" SET [DocumentDate] = GETDATE()   ");
