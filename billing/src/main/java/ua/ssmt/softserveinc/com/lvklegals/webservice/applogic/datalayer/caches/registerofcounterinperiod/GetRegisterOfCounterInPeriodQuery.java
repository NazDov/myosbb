 ...
 */
public class GetRegisterOfCounterInPeriodQuery extends AbstractSelectQuery<RegisterOfCounter,Void> {
    public GetRegisterOfCounterInPeriodQuery(Void condition) {
        super(condition);
    }
    ...
    protected String getSQLQuery() {
        ...
        sb.append(" (select departmentInputID from dbo.getDepartmentInputByID()) and Period = dbo.getCurrentPeriod()  ");
        sb.append(" and onDate > dbo.getCurrentPeriod()");
