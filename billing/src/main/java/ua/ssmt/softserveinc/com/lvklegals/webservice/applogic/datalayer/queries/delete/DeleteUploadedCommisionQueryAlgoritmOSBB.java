 ...
 */
public class DeleteUploadedCommisionQueryAlgoritmOSBB extends AbstractModifyQuery<Commission> {
    @Override
    protected String getSQLQuery() {
        StringBuilder sb = new StringBuilder();
        sb.append("delete from [dbo].[DocCommission] where [period] = ? and [Algorithm] = 3");
        return sb.toString();
    }
