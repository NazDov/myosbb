...
import ua.ssmt.softserveinc.com.lvklegals.webservice.applogic.datalayer.queries.update.UpdateCorrectionOfRealizeQuery;
 ...
 */
public class UpdateCorrectionOfRealizeOperation extends AbstractModifyOperation<CorrectionOfRealize> {

    public UpdateCorrectionOfRealizeOperation() {
        super(new CorrectionOfRealizeValidator());
    }

    @Override
    protected long _doOperation(Connection connection, CorrectionOfRealize value)   {
        new UpdateCorrectionOfRealizeQuery().execute(connection,value);
