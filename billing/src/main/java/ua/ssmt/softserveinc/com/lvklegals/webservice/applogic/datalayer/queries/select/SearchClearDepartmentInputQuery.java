 ...
 */
public class SearchClearDepartmentInputQuery extends AbstractSelectQuery<DepartmentInput,DepartmentInputCondition> {

    public SearchClearDepartmentInputQuery(DepartmentInputCondition condition) {
        super(condition);
    }
