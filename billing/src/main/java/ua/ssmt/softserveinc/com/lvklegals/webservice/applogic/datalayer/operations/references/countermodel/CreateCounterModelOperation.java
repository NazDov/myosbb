...
import ua.ssmt.softserveinc.com.lvklegals.webservice.applogic.datalayer.queries.create.CreateCounterModelQuery;
 ...
 */
public class CreateCounterModelOperation extends AbstractModifyOperation<CounterModel> {
    public CreateCounterModelOperation() {
        super(new CounterModelValidator());
    }

    @Override
    protected long _doOperation(Connection connection, CounterModel value)   {
        new CreateCounterModelQuery().execute(connection,value);
        return 0;
    }
